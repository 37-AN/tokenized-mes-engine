...
export function AssetTokenization() {
  ...
  useEffect(() => {
    if (active && library && contractAddress) {
      const service = new AssetTokenService(library, contractAddress);
      setAssetService(service);
      console.log('Asset token service initialized');
    }
    ...
    <Card className="p-6 space-y-4">
      <div className="space-y-4">
        <div>
          ...
          <Input
            type="text"
            placeholder="Enter asset token contract address"
